# Symply Budget Acceptance Results — language
...
| Fail | 14 |
| N/A | 529 |
| Pass rate (excl. N/A) | 54.8% |
| Maestro flows (merged) | 4 (2 pass / 2 fail) |

**Harness notes**

- **Merged Maestro logs:** —
- **Flows scored:** 4 (2 pass / 2 fail) on /tmp/maestro-language-2026-07-19.log
...
|------|--------|--------|-----|
| `budget-savings-overview` | Fail | savings-goals-add-list not visible (smoke4) | `smoke-supplement` |
| `budget-settings` | Fail | budget-settings-timeline-link scroll (smoke3) | `smoke-supplement` |
| `budget-tabs` | Pass | smoke3 | `smoke-supplement` |
| `check-spendings-layout` | Pass | smoke3 | `smoke-supplement` |

**Open failures (fix queue)**

- `budget-savings-overview.yaml` — savings-goals-add-list not visible (smoke4)
- `budget-settings.yaml` — budget-settings-timeline-link scroll (smoke3)
...
| BUDGET-SMOKE-003 | Dashboard smoke controls | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-SMOKE-004 | Planning smoke | | | | Maestro | `e2e/maestro/budget/check-spendings-layout.yaml` | ☑ | ☐ | ☐ | Flow `check-spendings-layout.yaml` |
| BUDGET-SMOKE-005 | Savings overview smoke | | | | Maestro | `e2e/maestro/budget/budget-savings-overview.yaml` | ☐ | ☑ | ☐ | Flow `budget-savings-overview.yaml` failed — savings-goals-add-list not visible (smoke4) |
| BUDGET-SMOKE-006 | Chat FAB present | | | | Maestro, Unit | `e2e/maestro/budget/budget-chat-rooms.yaml`, `src/features/b | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-rooms |
| BUDGET-SMOKE-007 | Settings entry reachable | | | | Maestro | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
...
| BUDGET-DASH-001 | Dashboard load | | | | Maestro, Unit | `e2e/maestro/budget/budget-dashboard-controls.yaml`, `src/sc | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
...
| BUDGET-DASH-003 | Month prev visible | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-004 | Month prev interact | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-005 | Month next visible | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-006 | Month next interact | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-007 | Encouragement banner load | | | | Maestro, Unit | `e2e/maestro/budget/budget-dashboard-widgets.yaml`, `src/scr | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-widgets |
| BUDGET-DASH-008 | Category spending chart load | | | | Maestro, Unit | `e2e/maestro/budget/budget-dashboard-widgets.yaml`, `src/scr | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-widgets |
| BUDGET-DASH-009 | Category row tap | | | | Maestro | `e2e/maestro/budget/budget-category-detail.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-category-detail |
| BUDGET-DASH-010 | Savings headroom card load | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-011 | Open goals shortcut | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-012 | Insights card load | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-013 | Insights refresh visible | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-014 | Insights refresh interact | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
...
| BUDGET-DASH-016 | Add planned visible | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-017 | Add planned opens form | | | | Maestro | `e2e/maestro/budget/budget-item-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-item-form |
| BUDGET-DASH-018 | Add spent visible | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
| BUDGET-DASH-019 | Add spent opens form | | | | Maestro | `e2e/maestro/budget/budget-spent-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spent-form |
| BUDGET-DASH-020 | Add with AI visible | | | | Maestro | `e2e/maestro/budget/budget-ai-screen.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen |
| BUDGET-DASH-021 | Add with AI opens screen | | | | Maestro | `e2e/maestro/budget/budget-ai-screen.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen |
| BUDGET-DASH-022 | Dashboard add row visible | | | | Maestro | `e2e/maestro/budget/budget-dashboard-controls.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-controls |
...
| BUDGET-DASH-032 | Overview offline error | | | | Maestro | `e2e/maestro/budget/budget-dashboard-offline.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-dashboard-offline |
...
| BUDGET-DASH-035 | Header settings gear opens Budget settings | | | | Maestro | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
...
| BUDGET-PLAN-005 | Create planned item | | | | Maestro, Unit, API | `e2e/maestro/budget/budget-item-form.yaml`, `src/screens/bud | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-item-form |
| BUDGET-PLAN-006 | Edit planned item | | | | Maestro, Unit | `e2e/maestro/budget/budget-item-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-item-form |
...
| BUDGET-PLAN-009 | Delete planned item | | | | Maestro | `e2e/maestro/budget/budget-plan-delete.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-plan-delete |
...
| BUDGET-PLAN-013 | Categories screen load | | | | Maestro, Unit | `e2e/maestro/budget/budget-categories.yaml`, `src/screens/bu | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-categories |
| BUDGET-PLAN-014 | Create custom category | | | | Maestro, Unit | `e2e/maestro/budget/budget-categories.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-categories |
...
| BUDGET-PLAN-017 | Category detail load | | | | Maestro, Unit | `e2e/maestro/budget/budget-category-detail.yaml`, `src/scree | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-category-detail |
| BUDGET-PLAN-018 | Category detail month stepper | | | | Maestro | `e2e/maestro/budget/budget-category-detail.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-category-detail |
...
| BUDGET-PLAN-022 | BudgetItemAI load | | | | Maestro | `e2e/maestro/budget/budget-ai-screen.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen |
| BUDGET-PLAN-023 | AI detect text | | | | Maestro, API | `e2e/maestro/budget/budget-ai-screen.yaml`, `budget-ai-detec | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen |
| BUDGET-PLAN-024 | AI detect with attachment | | | | Maestro, API | `e2e/maestro/budget/budget-ai-screen.yaml`, `backend/src/rou | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen |
| BUDGET-PLAN-025 | AI gate without entitlement | | | | API | `budget-ai-detect.test.ts` | ☐ | ☐ | ☑ | Consolidated flow — no yaml mapping |
| BUDGET-PLAN-026 | Save AI suggestion to item | | | | Maestro | `e2e/maestro/budget/budget-item-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-item-form |
| BUDGET-PLAN-027 | Cancel AI screen | | | | Maestro | `e2e/maestro/budget/budget-ai-screen.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen |
| BUDGET-PLAN-028 | Transfer screen load | | | | Maestro, Unit | `e2e/maestro/budget/budget-transfer.yaml`, `src/screens/budg | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
| BUDGET-PLAN-029 | Transfer destination select | | | | Maestro | `e2e/maestro/budget/budget-transfer.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
| BUDGET-PLAN-030 | Create transfer | | | | Maestro, API | `e2e/maestro/budget/budget-transfer.yaml`, `budget-transfers | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
| BUDGET-PLAN-031 | Move all leftover | | | | Maestro | `e2e/maestro/budget/budget-transfer.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
| BUDGET-PLAN-032 | Undo transfer | | | | Maestro, API | `e2e/maestro/budget/budget-transfer.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
...
| BUDGET-PLAN-034 | Cancel transfer screen | | | | Maestro | `e2e/maestro/budget/budget-transfer.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
| BUDGET-PLAN-035 | Sync action items | | | | API | `backend/src/routes/__tests__/budget.test.ts` | ☐ | ☐ | ☑ | Consolidated flow — no yaml mapping |
| BUDGET-PLAN-036 | Set monthly goal via settings link | | | | Maestro, Unit | `e2e/maestro/budget/budget-settings.yaml`, `src/screens/budg | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
...
| BUDGET-PLAN-067 | Transfer destination testID format | | | | Maestro | `e2e/maestro/budget/budget-transfer.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
...
| BUDGET-SPEND-003 | Add spent visible | | | | Maestro | `e2e/maestro/budget/budget-spent-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spent-form |
| BUDGET-SPEND-004 | Create spent entry | | | | Maestro, Unit | `e2e/maestro/budget/budget-spent-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spent-form |
| BUDGET-SPEND-005 | Edit spent entry | | | | Maestro | `e2e/maestro/budget/budget-spent-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spent-form |
| BUDGET-SPEND-006 | Duplicate spent entry | | | | Maestro | `e2e/maestro/budget/budget-spend-mutations.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spend-mutations |
| BUDGET-SPEND-007 | Delete spent entry | | | | Maestro | `e2e/maestro/budget/budget-spend-mutations.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spend-mutations |
...
| BUDGET-SPEND-010 | Scan receipt visible | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
| BUDGET-SPEND-011 | Open receipt scan screen | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
| BUDGET-SPEND-012 | Receipt pick from gallery | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml`, `e2e/maestro/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan, pick-photo-from-library |
| BUDGET-SPEND-013 | Receipt OCR scan | | | | Maestro, API | `e2e/maestro/budget/budget-receipt-scan.yaml`, `budget-recei | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
| BUDGET-SPEND-014 | Toggle receipt line item | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
...
| BUDGET-SPEND-016 | Bulk save receipt items | | | | Maestro, API | `e2e/maestro/budget/budget-receipt-scan.yaml`, `budget-recei | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
...
| BUDGET-SPEND-018 | Cancel receipt scan | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
| BUDGET-SPEND-019 | Add with AI from spending | | | | Maestro | `e2e/maestro/budget/budget-ai-screen.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen |
...
| BUDGET-SPEND-023 | Spent form cancel | | | | Maestro | `e2e/maestro/budget/budget-spent-form.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spent-form |
...
| BUDGET-SPEND-029 | Offline add spent | | | | Maestro | `e2e/maestro/budget/budget-spend-mutations.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spend-mutations |
...
| BUDGET-SPEND-033 | Camera receipt source | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
| BUDGET-SPEND-034 | Drive receipt source | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
...
| BUDGET-SPEND-045 | Receipt file source | | | | Maestro | `e2e/maestro/budget/budget-receipt-scan.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-receipt-scan |
...
| BUDGET-SPEND-048 | Delete expense round-trip | | | | Maestro | `e2e/maestro/budget/budget-spend-mutations.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-spend-mutations |
| BUDGET-SAVE-001 | Savings tab load | | | | Maestro | `e2e/maestro/budget/budget-savings-overview.yaml` | ☐ | ☑ | ☐ | Flow `budget-savings-overview.yaml` failed — savings-goals-add-list not visible (smoke4) |
| BUDGET-SAVE-002 | Savings overview cards | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-overview.yaml`, `src/scre | ☐ | ☑ | ☐ | Flow `budget-savings-overview.yaml` failed — savings-goals-add-list not visible (smoke4) |
| BUDGET-SAVE-003 | Income sub-tab load | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-income-entry.yaml`, `src/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-income-entry |
| BUDGET-SAVE-004 | Create income entry | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-income-entry.yaml`, `src/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-income-entry |
...
| BUDGET-SAVE-009 | Goals sub-tab load | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-goal.yaml`, `src/screens/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-goal |
| BUDGET-SAVE-010 | Create savings goal | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-goal.yaml`, `src/screens/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-goal |
...
| BUDGET-SAVE-013 | Recurring payments screen | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-recurring.yaml`, `src/scr | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-recurring |
| BUDGET-SAVE-014 | Add recurring payment | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-recurring.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-recurring |
...
| BUDGET-SAVE-016 | Import screen load | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-import.yaml`, `src/screen | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-import |
| BUDGET-SAVE-017 | Import commit | | | | Maestro, Unit | `e2e/maestro/budget/budget-savings-import.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-import |
...
| BUDGET-SAVE-038 | Offline savings save | | | | Maestro | `e2e/maestro/budget/budget-savings-offline.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-offline |
...
| BUDGET-SAVE-042 | Transfer to savings goal | | | | Maestro, API | `e2e/maestro/budget/budget-transfer.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-transfer |
...
| BUDGET-SAVE-045 | Savings sub-tab testIDs | | | | Maestro | `e2e/maestro/budget/budget-savings-overview.yaml` | ☐ | ☑ | ☐ | Flow `budget-savings-overview.yaml` failed — savings-goals-add-list not visible (smoke4) |
| BUDGET-SAVE-046 | Savings month stepper | | | | Maestro | `e2e/maestro/budget/budget-savings-month-stepper.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-month-stepper |
...
| BUDGET-SAVE-087 | One-off income round-trip on device (E2E) | | | | Maestro | `e2e/maestro/budget/budget-savings-irregular-income.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-savings-irregular-income |
...
| BUDGET-PEN-001 | Pension screen load | | | | Maestro | `e2e/maestro/budget/budget-pension.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-pension |
...
| BUDGET-PEN-011 | Import extract preview | | | | Maestro | `e2e/maestro/budget/budget-pension-interactions.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-pension-interactions |
...
| BUDGET-PEN-016 | Pension interactions smoke | | | | Maestro | `e2e/maestro/budget/budget-pension-interactions.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-pension-interactions |
...
| BUDGET-PEN-028 | Offline pension save | | | | Maestro | `e2e/maestro/budget/budget-pension-offline.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-pension-offline |
...
| BUDGET-PEN-033 | Pension year stepper | | | | Maestro | `e2e/maestro/budget/budget-pension-interactions.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-pension-interactions |
| BUDGET-PEN-034 | Pension sub-tab testIDs | | | | Maestro | `e2e/maestro/budget/budget-pension.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-pension |
...
| BUDGET-BILL-001 | Bills screen load | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-BILL-003 | Utility accounts list | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-BILL-007 | Add bill manually | | | | Unit, Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
| BUDGET-BILL-008 | Edit bill | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-BILL-010 | Mark bill paid | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-BILL-012 | Upload bill document | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-BILL-028 | Cancel bill form | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-BILL-031 | Bills view state testID collision | | | | Maestro | `e2e/maestro/budget/budget-bills-states.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills-states |
| BUDGET-BILL-032 | Provider rows | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
| BUDGET-BILL-033 | Bills quick actions | | | | Maestro | `e2e/maestro/budget/budget-bills.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-BILL-038 | Reminders list | | | | API | `backend/src/routes/__tests__/utilities.test.ts`, `e2e/maest | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-bills |
...
| BUDGET-WISH-001 | Wishes list load | | | | Maestro, Unit | `e2e/maestro/budget/budget-wishes.yaml`, `src/screens/budget | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-wishes |
...
| BUDGET-WISH-008 | Add photo entry | | | | Maestro | `e2e/maestro/budget/budget-wishes.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-wishes |
...
| BUDGET-WISH-023 | Wishes list controls | | | | Maestro | `e2e/maestro/budget/budget-wishes.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-wishes |
...
| BUDGET-BCHAT-001 | Chat rooms load | | | | Maestro | `e2e/maestro/budget/budget-chat-rooms.yaml`, `e2e/maestro/su | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-rooms, budget-open-chat-rooms |
...
| BUDGET-BCHAT-004 | Open chat room | | | | Maestro | `e2e/maestro/budget/budget-chat-message.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-message |
| BUDGET-BCHAT-005 | Send text message | | | | Maestro | `e2e/maestro/budget/budget-chat-message.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-message |
...
| BUDGET-BCHAT-011 | Attach photo | | | | Maestro | `e2e/maestro/budget/budget-chat-message.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-message |
...
| BUDGET-BCHAT-013 | Budget AI assistant screen | | | | Maestro | `e2e/maestro/budget/budget-ai-screen.yaml`, `e2e/maestro/bud | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-ai-screen, budget-chat-assistant |
| BUDGET-BCHAT-014 | AI assistant send prompt | | | | Maestro | `e2e/maestro/budget/budget-chat-assistant.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-assistant |
...
| BUDGET-BCHAT-016 | Chat FAB visible | | | | Maestro, Unit | `e2e/maestro/budget/budget-chat-fab-visible.yaml`, `src/feat | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-fab-visible |
...
| BUDGET-BCHAT-018 | Cancel message compose | | | | Maestro | `e2e/maestro/budget/budget-chat-message.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-message |
...
| BUDGET-BCHAT-023 | Offline send message | | | | Maestro | `e2e/maestro/budget/budget-chat-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-extended |
...
| BUDGET-BCHAT-026 | Assistant cancel mid-stream | | | | Maestro | `e2e/maestro/budget/budget-chat-assistant.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-assistant |
| BUDGET-BCHAT-027 | Rooms list empty state | | | | Maestro | `e2e/maestro/budget/budget-chat-rooms.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-rooms |
...
| BUDGET-BCHAT-035 | Mention bar rows | | | | Maestro | `e2e/maestro/budget/budget-chat-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-extended |
...
| BUDGET-BCHAT-037 | Assistant reply arrives over the WebSocket | | | | Maestro | `e2e/maestro/budget/budget-chat-assistant.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-assistant |
...
| BUDGET-BCHAT-043 | Room settings screen has no testIDs | | | | Maestro | `e2e/maestro/budget/budget-chat-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-extended |
| BUDGET-BCHAT-044 | Delete room confirmation | | | | Maestro | `e2e/maestro/budget/budget-chat-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-extended |
...
| BUDGET-BCHAT-046 | Chat rooms pull-to-refresh | | | | Maestro | `e2e/maestro/budget/budget-chat-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-chat-extended |
| BUDGET-ST-001 | Data sharing settings load | | | | Maestro | `e2e/maestro/budget/budget-data-sharing.yaml`, `e2e/maestro/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-data-sharing, budget-settings-more |
| BUDGET-ST-002 | Revoke data sharing package | | | | Maestro | `e2e/maestro/budget/budget-data-sharing.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-data-sharing |
| BUDGET-ST-003 | Soft Transfer export screen load | | | | Maestro, Unit | `e2e/maestro/budget/budget-soft-transfer-export.yaml`, `src/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-soft-transfer-export |
| BUDGET-ST-004 | Soft Transfer export UI steps | | | | Maestro | `e2e/maestro/budget/budget-soft-transfer-export.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-soft-transfer-export |
| BUDGET-ST-005 | Soft Transfer import screen load | | | | Maestro, Unit | `e2e/maestro/budget/budget-soft-transfer-import.yaml`, `src/ | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-soft-transfer-import |
| BUDGET-ST-006 | Soft Transfer import preview | | | | Maestro | `e2e/maestro/budget/budget-soft-transfer-import.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-soft-transfer-import |
...
| BUDGET-ST-011 | Cancel export wizard | | | | Maestro | `e2e/maestro/budget/budget-soft-transfer-export.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-soft-transfer-export |
| BUDGET-ST-012 | Cancel import wizard | | | | Maestro | `e2e/maestro/budget/budget-soft-transfer-import.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-soft-transfer-import |
| BUDGET-ST-013 | Data sharing link visible | | | | Maestro | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
| BUDGET-ST-014 | ST export link visible | | | | Maestro | `e2e/maestro/budget/budget-settings-more.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-more |
| BUDGET-ST-015 | ST import link visible | | | | Maestro | `e2e/maestro/budget/budget-settings-more.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-more |
...
| BUDGET-ST-017 | Consent + package list endpoints | | | | Maestro | `e2e/maestro/budget/budget-data-sharing.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-data-sharing |
...
| BUDGET-ST-019 | Revoke consent | | | | Maestro | `e2e/maestro/budget/budget-data-sharing.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-data-sharing |
| BUDGET-ST-020 | Transfer wizard control inventory | | | | Maestro | `e2e/maestro/budget/budget-soft-transfer-export.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-soft-transfer-export |
...
| BUDGET-SETT-001 | Settings screen load | | | | Maestro, Unit | `e2e/maestro/budget/budget-settings.yaml`, `src/screens/budg | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
| BUDGET-SETT-002 | Month grid visible | | | | Maestro | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
| BUDGET-SETT-003 | Select month cell | | | | Maestro | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
| BUDGET-SETT-004 | Planned budget input | | | | Maestro, Unit | `e2e/maestro/budget/budget-settings-extended.yaml`, `src/scr | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-extended |
| BUDGET-SETT-005 | Save month goal | | | | Maestro, Unit | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
...
| BUDGET-SETT-007 | Transfer nav link | | | | Maestro | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
| BUDGET-SETT-008 | Categories nav link | | | | Maestro | `e2e/maestro/budget/budget-categories.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-categories |
| BUDGET-SETT-009 | Timeline nav link | | | | Maestro | `e2e/maestro/budget/budget-settings-extended.yaml`, `src/scr | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-extended |
| BUDGET-SETT-010 | History nav link | | | | Maestro | `e2e/maestro/budget/budget-settings-extended.yaml`, `src/scr | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-extended |
| BUDGET-SETT-011 | Compare nav link | | | | Maestro | `e2e/maestro/budget/budget-settings-extended.yaml`, `src/scr | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-extended |
...
| BUDGET-SETT-017 | Settings more submenu | | | | Maestro | `e2e/maestro/budget/budget-settings-more.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-more |
...
| BUDGET-SETT-021 | Offline save settings | | | | Maestro | `e2e/maestro/budget/budget-settings-offline.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-offline |
| BUDGET-SETT-022 | More hub load | | | | Maestro | `e2e/maestro/budget/budget-settings-more.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-settings-more |
| BUDGET-SETT-023 | Settings nav-link inventory | | | | Maestro | `e2e/maestro/budget/budget-settings.yaml` | ☐ | ☑ | ☐ | Flow `budget-settings.yaml` failed — budget-settings-timeline-link scroll (smoke3) |
| BUDGET-SETT-024 | Timeline screen is untestable by testID | | | | Maestro | `e2e/maestro/budget/budget-timeline-year-setup.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-timeline-year-setup |
| BUDGET-SETT-025 | Year-setup screen is untestable by testID | | | | Maestro | `e2e/maestro/budget/budget-timeline-year-setup.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-timeline-year-setup |
...
| BUDGET-SETT-029 | Tab customisation screen | | | | Maestro | `e2e/maestro/budget/budget-customize-tabs.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-customize-tabs |
...
| BUDGET-SETT-031 | Legacy `/budget` deep link redirects | | | | Maestro | `e2e/maestro/budget/budget-customize-tabs.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-customize-tabs |
...
| BUDGET-HH-001 | Households screen load | | | | Maestro, Unit | `e2e/maestro/budget/budget-households.yaml`, `src/features/b | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-households |
...
| BUDGET-HH-003 | Switch household | | | | Maestro, Unit | `e2e/maestro/budget/budget-household-switch.yaml`, `src/feat | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-household-switch |
...
| BUDGET-HH-005 | Create household FAB | | | | Maestro, Unit | `e2e/maestro/budget/budget-households.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-households |
| BUDGET-HH-006 | Create household save | | | | Maestro, Unit | `e2e/maestro/budget/budget-household-switch.yaml`, `src/feat | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-household-switch |
...
| BUDGET-HH-015 | Households scroll | | | | Maestro | `e2e/maestro/budget/budget-household-extended.yaml` | ☐ | ☐ | ☑ | iOS 26 scroll driver limit — optional scroll subflow |
| BUDGET-HH-016 | Offline create household | | | | Maestro | `e2e/maestro/budget/budget-household-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-household-extended |
| BUDGET-HH-017 | Add-household FAB has no testID | | | | Maestro | `e2e/maestro/budget/budget-households.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-households |
| BUDGET-HH-018 | Swipe-to-edit on a household row | | | | Maestro | `e2e/maestro/budget/budget-household-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-household-extended |
...
| BUDGET-HH-025 | Manage members and invites | | | | Maestro | `e2e/maestro/budget/budget-household-extended.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-household-extended |
| BUDGET-HH-026 | Invite by email and by link | | | | API | `backend/src/services/__tests__/household-invite-remove.test | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-household-extended |
| BUDGET-HH-027 | Join-request approve / deny | | | | POST 2xx | API | ☐ | ☐ | ☑ | Consolidated flow — no yaml mapping |
| BUDGET-HH-028 | Remove a member | | | | API | `backend/src/services/__tests__/household-invite-remove.test | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-household-extended |
...
| BUDGET-CORNER-017 | Offline behaviour across money mutations | | | | Maestro | `e2e/maestro/budget/budget-offline-sweep.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-offline-sweep |
...
| BUDGET-CORNER-019 | Duplicate testIDs break Maestro selection | | | | Maestro | `e2e/maestro/budget/budget-corner-testids.yaml` | ☐ | ☐ | ☑ | No suite run for cited flow(s): budget-corner-testids |
