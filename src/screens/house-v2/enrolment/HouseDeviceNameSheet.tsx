...
import { DEVICE_NAME_MAX_LENGTH, normalizeDeviceName } from '@features/house/local/deviceName';
 ...
 *
 * Named devices are the whole point of the trusted-device list: "Remove
 * dev_652de89b0240" is a decision nobody can make. The OS name is pre-filled, so
 * the common path is open → Save, and typing is only for homes where two phones
 * answer to the same name.
 */
export function HouseDeviceNameSheet({ visible, value, suggestion, onClose, onSave }: Props) {
    ...
    >
      <View style={styles.body}>
        <Typography variant="caption1" color={colors.textSecondary}>
          Everyone in your home sees this name in their device list. It is stored with your home,
          never shown outside it.
        </Typography>

        <TextInput
          testID="house-device-name-input"
          label="Device name"
        ...
        {canUseSuggestion ? (
          <TouchableOpacity
            ...
            testID="house-device-name-use-suggestion"
...
export default HouseDeviceNameSheet;
