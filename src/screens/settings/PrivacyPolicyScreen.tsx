...
import { buildPrivacySections, LegalSections } from '@components/onboarding';
...
/**
 * Privacy Policy — shared UI, per-brand content. The document body comes from
 * the active brand's content pack (@config/brandContent) via the shared
 * LegalDocument builders, so every app renders its own Privacy Policy without
 * forking this screen. Same content is shown in the onboarding agreement sheet.
 */
export function PrivacyPolicyScreen({ navigation }: BackOnlyScreenProps = {}) {
